...
public class RandomBoardGenerator implements IBoardGenerator {
	...
	public void generate(Board board) {
		...
		int[][] tileNodes = {
			{1, 2, 3, 4, 5, 0},    		// Tile  0
			{16, 17, 18, 13, 3, 2}, 	// Tile  1
			{3, 13, 14, 15, 10, 4}, 	// Tile  2
			{5, 4, 10, 11, 12, 8},  	// Tile  3
			{7, 0, 5, 8, 9, 6}, 		// Tile  4
			{23, 19, 1, 0, 7, 22},  	// Tile  5
			{20, 21, 16, 2, 1, 19}, 	// Tile  6
			{40, 41, 42, 38, 18, 17},	// Tile  7
			{18, 38, 39, 35, 14, 13},  	// Tile  8
			{14, 35, 36, 37, 33, 15}, 	// Tile  9
			{10, 15, 33, 34, 30, 11}, 	// Tile 10
			{12, 11, 30, 31, 32, 28}, 	// Tile 11
			{9, 8, 12, 28, 29, 26}, 	// Tile 12
