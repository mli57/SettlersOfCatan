...
/**
 * Encapsulates all placement operations and board-query helpers.
 * Fully functional for AI players; extended by HumanPlayerActions for interactive play.
...
public class PlayerActions {
	 ...
	 */
	public PlayerActions(Board board, Bank bank, IPlacementValidator validator, Player[] players, Random random) {
		this.board = board;
		this.bank = bank;
